  ...
  refresh: function(frm) {
    ...
    for (var i = 0; i < frm.doc.elements_colors.length; i++) {
      if (frm.doc.elements_colors.length > 0) {
        console.log(frm.doc.elements_colors[i].class)
        $(frm.doc.elements_colors[i].class).css("color", frm.doc.elements_colors[i].color);
        style = style + (frm.doc.elements_colors[i].class + " {\ncolor : " + frm.doc.elements_colors[i].color + "\n}\n");
        console.log(style)
      }
    }
  },
